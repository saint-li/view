...
public class CircularProgressView extends View {
    ...
    public CircularProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        float radius = typedArray.getDimension(R.styleable.CircularProgressView_shadowRadius, 0);
        if (radius > 0)
            mProgPaint.setMaskFilter(new BlurMaskFilter(radius, BlurMaskFilter.Blur.SOLID));
