...
public class SportProgressView extends View {
    ...
    private void init() {
        ...
        marginBottom = getTextHeight(mTextPaint) + getResources().getDimension(R.dimen.dp_10);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mWidth = (int) (mProgressR * 2 + mProgressWidth + getPaddingLeft() + getPaddingRight());
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int right = (int) (left + 2 * mProgressR);
        int top = (int) (mHeight - marginBottom - mProgressR);
        int bottom = (int) (mHeight - marginBottom + mProgressR);
